        ...
        <div className="flex flex-col gap-4">
          ...
          {neighborhoods.length > 1 && (
            <div className="flex items-center gap-3">
              <span className="text-xs font-medium uppercase tracking-widest text-forest/40">
                Neighbourhood
              </span>
              <select
              ...
              {neighborhoodFilter !== "All" && (
                <button
                  ...
                  className="text-xs text-forest/40 underline underline-offset-2 hover:text-forest/60"
                >
                  Clear
                </button>
              )}
  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {Array.from({ length: 6 }).map((_, i) => (
        ...
        >
          <div className="h-32 bg-forest/10" />
